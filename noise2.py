...
if __name__ == '__main__':
    ...
    prods1 = x_train[:120000]
    reacs1 = y_train[:120000]
    labels1 = z_train[:120000]
    #prods = x_train[120000:]
    #reacs = y_train[120000:]
    prods = x_train[:120000]
    reacs = y_train[:120000]
    
    #labels = z_train[120000:]
    '''
...
#            continue
    ...
    with open('data/x_train0-smaO.pickle', 'wb') as f:
        pickle.dump(prods1, f)
#    with open('data/x_train0-smaM.pickle', 'wb') as f:
#        pickle.dump(prods, f)
    with open('data/y_train0-smaO.pickle', 'wb') as f:
        pickle.dump(reacs1, f)
#    with open('data/y_train0-smaM.pickle', 'wb') as f:
#        pickle.dump(reacs, f)
    with open('data/z_train0-smaO.pickle', 'wb') as f:
        pickle.dump(labels1, f)
        
    #'''
    with open('data/z_train0-smaMself2.pickle', 'wb') as f:
...
#    transforms.sort()
#    with open('data/inscopedata2_noise9test.dat', 'w') as f:
